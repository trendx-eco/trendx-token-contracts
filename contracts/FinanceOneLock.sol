...
contract FinanceOneLock {
    ...
    uint256 public constant TGE_PERCENTAGE = 5; // TGE release percentage
    ...
    function releasableAmount() public view returns (uint256) {
        ...
        uint256 intervals = elapsedTime.div(RELEASE_INTERVAL); // The number of release cycles that have passed
